...
public class OnChainSignatureTenantService
{
    ...
    public OnChainSignatureTenantService(IContractOptions<OnChainSignatureTenantService> options)
    {
        if (string.IsNullOrWhiteSpace(options.RpcUrl))
            throw new ArgumentException("RpcUrl is required for OnChainSignatureTenantService", nameof(options));
        if (string.IsNullOrWhiteSpace(options.Address))
            throw new ArgumentException("Address is required for OnChainSignatureTenantService", nameof(options));
