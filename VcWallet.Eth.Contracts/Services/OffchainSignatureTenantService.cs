...
public class OffchainSignatureTenantService
{
    ...
    public OffchainSignatureTenantService(IContractOptions<OffchainSignatureTenantService> options)
    {
        if (string.IsNullOrWhiteSpace(options.RpcUrl))
            throw new ArgumentException("RpcUrl is required for OffchainSignatureTenantService", nameof(options));
        if (string.IsNullOrWhiteSpace(options.Address))
            throw new ArgumentException("Address is required for OffchainSignatureTenantService", nameof(options));
